...
public class SWTResourceManager {
	...
	//
	////////////////////////////////////////////////////////////////////////////
	private static Map<RGB, Color> rgbToColorMap = new HashMap<RGB, Color>();
	/**
	...
	public static Color getColor(RGB rgb) {
		Color color = rgbToColorMap.get(rgb);
		if (color == null) {
			Display display = Display.getCurrent();
			color = new Color(display, rgb);
			rgbToColorMap.put(rgb, color);
		}
		return color;
	}
	/**
	...
	public static void disposeColors() {
		for (Color color : rgbToColorMap.values()) {
			color.dispose();
		}
		rgbToColorMap.clear();
	}
