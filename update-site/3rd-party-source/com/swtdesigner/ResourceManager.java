...
public class ResourceManager extends SWTResourceManager {
	...
	//
	////////////////////////////////////////////////////////////////////////////
	private static Map<ImageDescriptor, Image> descriptorToImageMap = new HashMap<ImageDescriptor, Image>();
	/**
	...
	public static Image getImage(ImageDescriptor descriptor) {
		...
		Image image = descriptorToImageMap.get(descriptor);
		if (image == null) {
			image = descriptor.createImage();
			descriptorToImageMap.put(descriptor, image);
		}
		return image;
	}
	/**
	...
	public static void disposeImages() {
		...
		{
			for (Iterator<Image> I = descriptorToImageMap.values().iterator(); I.hasNext();) {
				I.next().dispose();
			}
			descriptorToImageMap.clear();
		}
   ...
   * @return the {@link Image} stored in the file at the specified path.
   * @deprecated use {@link RebelImage} instead
   */
